    ...
    <div className="mx-auto max-w-3xl space-y-4">
      ...
      <Card className="border-border">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm font-semibold text-foreground">Assigned Assets ({assetAssignments.length})</CardTitle>
        </CardHeader>
        <CardContent>
          {assetAssignments.length === 0 ? (
            <EmptyState title="No assets assigned" icon={Package} />
          ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        {` · Assigned ${new Date(aa.assignedAt).toLocaleDateString()}`}
