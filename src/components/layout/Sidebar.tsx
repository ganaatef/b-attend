...
const tenantOwnerNav: NavItem[] = [
  ...
  // HR section
  { href: "/hr", label: "HR Dashboard", icon: Briefcase, phase: 2 },
  { href: "/hr/departments", label: "Departments", icon: FolderTree, phase: 2 },
  { href: "/hr/job-titles", label: "Job Titles", icon: Award, phase: 2 },
  { href: "/hr/contracts", label: "Contracts", icon: FileText, phase: 3 },
  { href: "/hr/documents", label: "Documents", icon: ClipboardList, phase: 3 },
  { href: "/hr/leaves", label: "Leave Management", icon: CalendarDays, phase: 3 },
  { href: "/hr/warnings", label: "Warnings", icon: AlertTriangle, phase: 4 },
  { href: "/hr/training", label: "Training", icon: GraduationCap, phase: 4 },
  { href: "/hr/assets", label: "Assets", icon: Package, phase: 4 },
  { href: "/hr/payroll-profiles", label: "Payroll Profiles", icon: Wallet, phase: 5 },
  { href: "/hr/payroll-runs", label: "Payroll Runs", icon: CreditCard, phase: 5 },
  { href: "/hr/onboarding", label: "Onboarding", icon: UserPlus, phase: 4 },
  { href: "/hr/offboarding", label: "Offboarding", icon: UserMinus, phase: 4 },
...
const tenantEmployeeNav: NavItem[] = [
  ...
  { href: "/my-leave", label: "My Leave", icon: CalendarDays, phase: 3 },
  ...
  { href: "/my-training", label: "My Training", icon: GraduationCap, phase: 3 },
  { href: "/my-assets", label: "My Assets", icon: Package, phase: 3 },
  { href: "/my-warnings", label: "My Warnings", icon: AlertTriangle, phase: 3 },
