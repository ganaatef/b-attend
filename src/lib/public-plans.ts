...
const planDefinitions = [
  {
    slug: "trial", name: "Trial", nameAr: "تجريبي",
  ...
  {
    slug: "starter", name: "Starter", nameAr: "ستارتر",
  ...
  {
    slug: "growth", name: "Growth", nameAr: "نمو",
  ...
  {
    slug: "enterprise", name: "Enterprise", nameAr: "إنتربرايز",
...
export async function getPublicPlans(): Promise<PublicPlan[]> {
  try {
    ...
    console.warn("[PublicPlans] No active plans found; using fallback plans.");
  } catch (error) {
    console.warn("[PublicPlans] Database unavailable; using fallback plans.", error);
  }
