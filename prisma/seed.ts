...
async function main() {
  ...
  // ─────────────────────────────────────────────
  const employeeDefs = [
    { code: "EMP001", name: "Demo Employee", arabicName: "الموظف التجريبي", phone: "+20 100 111 0001", email: "employee@b-attend.app", branch: "NC", department: "Service", jobTitle: "Waiter", policy: "Morning", managerId: null },
    { code: "EMP002", name: "Sara Adel", arabicName: "سارة عادل", phone: "+20 100 111 0002", email: "emp002@b-attend.app", branch: "NC", department: "Service", jobTitle: "Waiter", policy: "Evening", managerId: null },
    { code: "EMP003", name: "Khaled Ibrahim", arabicName: "خالد إبراهيم", phone: "+20 100 111 0003", email: "emp003@b-attend.app", branch: "NC", department: "Kitchen", jobTitle: "Chef", policy: "Kitchen Double", managerId: null },
    { code: "EMP004", name: "Mona Sami", arabicName: "منى سامي", phone: "+20 100 111 0004", email: "emp004@b-attend.app", branch: "NC", department: "Cashier", jobTitle: "Cashier", policy: "Morning", managerId: null },
    { code: "EMP005", name: "Youssef Ali", arabicName: "يوسف علي", phone: "+20 100 111 0005", email: "emp005@b-attend.app", branch: "NC", department: "Delivery", jobTitle: "Driver", policy: "Evening", managerId: null },
    { code: "EMP006", name: "Fatma Hassan", arabicName: "فاطمة حسن", phone: "+20 100 111 0006", email: "emp006@b-attend.app", branch: "NS", department: "Service", jobTitle: "Waiter", policy: "Morning", managerId: null },
    { code: "EMP007", name: "Omar Khaled", arabicName: "عمر خالد", phone: "+20 100 111 0007", email: "emp007@b-attend.app", branch: "NS", department: "Kitchen", jobTitle: "Cook", policy: "Kitchen Double", managerId: null },
    { code: "EMP008", name: "Nour Ahmed", arabicName: "نور أحمد", phone: "+20 100 111 0008", email: "emp008@b-attend.app", branch: "NS", department: "Cashier", jobTitle: "Cashier", policy: "Evening", managerId: null },
    { code: "EMP009", name: "Mahmoud Adel", arabicName: "محمود عادل", phone: "+20 100 111 0009", email: "emp009@b-attend.app", branch: "NS", department: "Delivery", jobTitle: "Driver", policy: "Evening", managerId: null },
    { code: "EMP010", name: "Heba Samir", arabicName: "هبة سمير", phone: "+20 100 111 0010", email: "emp010@b-attend.app", branch: "NS", department: "Stewarding", jobTitle: "Steward", policy: "Morning", managerId: null },
    { code: "EMP011", name: "Tarek Mokhtar", arabicName: "طارق مختار", phone: "+20 100 111 0011", email: "emp011@b-attend.app", branch: "MD", department: "Service", jobTitle: "Waiter", policy: "Evening", managerId: null },
    { code: "EMP012", name: "Laila Mostafa", arabicName: "ليلى مصطفى", phone: "+20 100 111 0012", email: "emp012@b-attend.app", branch: "MD", department: "Kitchen", jobTitle: "Chef", policy: "Kitchen Double", managerId: null },
    { code: "EMP013", name: "Hossam Tarek", arabicName: "حسام طارق", phone: "+20 100 111 0013", email: "emp013@b-attend.app", branch: "MD", department: "Cashier", jobTitle: "Cashier", policy: "Morning", managerId: null },
    { code: "EMP014", name: "Reem Hassan", arabicName: "ريم حسن", phone: "+20 100 111 0014", email: "emp014@b-attend.app", branch: "MD", department: "Service", jobTitle: "Hostess", policy: "Part Time", managerId: null },
    { code: "EMP015", name: "Karim Nabil", arabicName: "كريم نبيل", phone: "+20 100 111 0015", email: "emp015@b-attend.app", branch: "MD", department: "Delivery", jobTitle: "Driver", policy: "Evening", managerId: null },
    { code: "MGR001", name: "New Cairo Manager", arabicName: "مدير فرع التجمع", phone: "+20 100 222 0001", email: "manager@b-attend.app", branch: "NC", department: "Management", jobTitle: "Branch Manager", policy: "Morning", managerId: null },
    { code: "MGR002", name: "Nasr City Manager", arabicName: "مدير فرع مدينة نصر", phone: "+20 100 222 0002", email: "manager2@b-attend.app", branch: "NS", department: "Management", jobTitle: "Branch Manager", policy: "Morning", managerId: null },
  ];
